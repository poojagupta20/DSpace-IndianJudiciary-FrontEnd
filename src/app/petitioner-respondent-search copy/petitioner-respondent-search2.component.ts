...
@Component({
  selector: 'app-petitioner-respondent-search2',
  templateUrl: './petitioner-respondent-search2.component.html',
  styleUrls: ['./petitioner-respondent-search2.component.scss']
})
export class PetitionerRespondentSearchComponent2 {
