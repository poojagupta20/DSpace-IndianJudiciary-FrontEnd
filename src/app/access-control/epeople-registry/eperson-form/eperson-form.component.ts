...
export class EPersonFormComponent implements OnInit, OnDestroy {
  ...
  lastName: DynamicInputModel;
  email: DynamicInputModel;
  // Add this property to the EPersonFormComponent class
   ...
   */
  createNewEPerson(values) {
    const ePersonToCreate = Object.assign(new EPerson(), {
      ...values,
      password: this.password.value // Add this line
    });
